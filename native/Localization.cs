    ...
    internal static class Localization
    {
        ...
        private static readonly Dictionary<string, Loc> Table = new Dictionary<string, Loc>
        {
            ["en"] = new Loc
            {
                ...
                From = "from {0}",
                UpdateAvailable = "New version {0} available – update now",
            ...
            ["de"] = new Loc
            {
                ...
                From = "von {0}",
                UpdateAvailable = "Neue Version {0} verfügbar – jetzt aktualisieren",
            ...
            ["fr"] = new Loc
            {
                ...
                From = "de {0}",
                UpdateAvailable = "Nouvelle version {0} disponible – mettre à jour",
            ...
            ["es"] = new Loc
            {
                ...
                From = "de {0}",
                UpdateAvailable = "Nueva versión {0} disponible – actualizar ahora",
            ...
            ["it"] = new Loc
            {
                ...
                From = "da {0}",
                UpdateAvailable = "Nuova versione {0} disponibile – aggiorna ora",
            ...
            ["pt"] = new Loc
            {
                ...
                From = "de {0}",
                UpdateAvailable = "Nova versão {0} disponível – atualizar agora",
            ...
            ["nl"] = new Loc
            {
                ...
                From = "van {0}",
                UpdateAvailable = "Nieuwe versie {0} beschikbaar – nu bijwerken",
            ...
            ["pl"] = new Loc
            {
                ...
                From = "od {0}",
                UpdateAvailable = "Dostępna nowa wersja {0} – zaktualizuj teraz",
            ...
            ["ru"] = new Loc
            {
                ...
                NoSubject = "(без темы)",
                From = "от {0}",
                UpdateAvailable = "Доступна новая версия {0} – обновить",
            ...
            ["tr"] = new Loc
            {
                ...
                NoSubject = "(konu yok)",
                From = "gönderen: {0}",
                UpdateAvailable = "Yeni sürüm {0} mevcut – şimdi güncelle",
            ...
            ["ja"] = new Loc
            {
                ...
                NoSubject = "（件名なし）",
                From = "差出人: {0}",
                UpdateAvailable = "新しいバージョン {0} が利用可能です – 今すぐ更新",
                Loading = "更新をダウンロード中…",
                UpdateBadge = "更新があります",
            ...
            ["ko"] = new Loc
            {
                ...
                NoSubject = "(제목 없음)",
                From = "보낸 사람: {0}",
                UpdateAvailable = "새 버전 {0} 사용 가능 – 지금 업데이트",
                Loading = "업데이트 다운로드 중…",
